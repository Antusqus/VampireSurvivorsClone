...
public class Tile
{
    ...
    {
        get => _heightValue;
        set { _heightValue = value > TerrainGenerator.BiomeTable.GetLength(0) -1  ? TerrainGenerator.BiomeTable.GetLength(0) - 1 : value; }
    }
    public float HeatValue
    {
        get => _heatValue;
        set { _heatValue = value > TerrainGenerator.BiomeTable.GetLength(0) - 1 ? TerrainGenerator.BiomeTable.GetLength(0) - 1 : value; }
    }
    public float MoistureValue
    {
        get => _moistValue;
        set { _moistValue = value > TerrainGenerator.BiomeTable.GetLength(0) - 1 ? TerrainGenerator.BiomeTable.GetLength(0) - 1 : value; }
    }
    public int X, Y;
    public int Bitmask;
    ...
    {
        return TerrainGenerator.BiomeTable[(int)tile.MoistureType, (int)tile.HeatType];
    }
}
