...
//    public static (MapData, MapData, MapData, System.Random) GenerateNoiseMapData(Vector2 coord, int mapWidth, int mapHeight, NoiseSettings settings, Vector2 sampleCentre, Material material)
//    {
...
//        //MountainMapScale *= (int)settings.scale;
//        //ElevationMapScale *= (int)settings.scale;
//        //TemperatureMapScale *= (int)settings.scale;
//        //HumidityMapScale *= (int)settings.scale;
...
//                float riverWindingScale = 90 + (25f * (mountainValue * 2f - 1f));
...
//        return (heightMap, MoistureData, HeatData, prng);
