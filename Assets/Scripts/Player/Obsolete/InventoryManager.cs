...
[System.Obsolete("Obsolete. Replaced by PlayerInventory.")]
public class InventoryManager : MonoBehaviour
{
    ...
    public class WeaponUpgrade
    {
        ...
        public GameObject initialWeaponController;
    ...
    {
        Debug.Log($"Adding {passiveItem.name} to {slotIndex}");
    ...
    void ApplyUpgradeOptions()
    {
        ...
        foreach (var upgradeOption in upgradeUIOptions)
        {
            ...
            {
                Debug.Log("Showing passives");
                Debug.Log("availablePassiveItemUpgrades.Count = " + availablePassiveItemUpgrades.Count);
            ...
            {
                Debug.Log("Showing weapons ");
                Debug.Log("availableWeaponUpgrades.Count = " + availableWeaponUpgrades.Count);
            ...
            else
            {
                ...
                Debug.Log("Random Choice: " + upgradeType);
                Debug.Log("availableWeaponUpgrades.Count = " + availableWeaponUpgrades.Count);
                Debug.Log("availablePassiveItemUpgrades.Count = " + availablePassiveItemUpgrades.Count);
            ...
            if (upgradeType == 1)
            {
                ...
                if (chosenWeaponUpgrade != null)
                {
                    ...
                    if (newWeapon)
                    {
                        upgradeOption.upgradeButton.onClick.AddListener(() => player.SpawnWeapon(chosenWeaponUpgrade.initialWeaponController));
